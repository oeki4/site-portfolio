<template>
<section class="info">
  <img class="info__photo" src="/assets/img/programmer2.png" alt="programmer">
  <div class="info__inner">
    ...
    <ul class="social-links">
      ...
      <li class="social-links__item">
        <a href="https://freelance.habr.com/freelancers/gumus54" target="_blank" rel="noopener noreferrer">
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" class="social-links__svg" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_48_35)">
              <path d="M0 0V30H30V0H0ZM8.78125 5H10.8225C12.3462 5 12.8725 5.03625 12.9075 5.14125C12.9313 5.22375 12.9425 6.8525 12.9425 8.7625L12.9325 12.2413L13.5275 11.7138C14.3487 10.9875 15.0425 10.73 16.355 10.6837C17.2225 10.66 17.5712 10.695 18.18 10.9063C19.505 11.3513 20.4425 12.265 20.935 13.6137C21.1225 14.14 21.1475 14.6925 21.1812 18.97L21.2188 23.75H17.0463V19.8487C17.0463 16.005 17.0338 15.9575 16.775 15.4887C16.4125 14.8675 16.0138 14.5862 15.3925 14.5162C14.3263 14.4 13.5888 14.7625 13.1675 15.6288C12.9675 16.0288 12.9437 16.4488 12.9325 19.8238C12.92 21.8863 12.895 23.6113 12.895 23.6575C12.885 23.7163 11.9575 23.75 10.8325 23.75H8.7825V14.375L8.78125 5Z" fill="#9071B4"/>
            </g>
            <defs>
